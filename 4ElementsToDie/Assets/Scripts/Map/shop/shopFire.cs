...
public class shopFire : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        airItem = enemyObjectCollection.getAirEquipment(1);
        earthItem = enemyObjectCollection.getEarthEquipment(3);
        fireItem = enemyObjectCollection.getFireEquipment(4);
        waterItem = enemyObjectCollection.getWaterEquipment(2);
