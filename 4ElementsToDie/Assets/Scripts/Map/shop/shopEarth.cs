...
public class shopEarth : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        airItem = enemyObjectCollection.getAirEquipment(2);
        earthItem = enemyObjectCollection.getEarthEquipment(4);
        fireItem = enemyObjectCollection.getFireEquipment(1);
        waterItem = enemyObjectCollection.getWaterEquipment(3);
